...
LIBSAVED="libGL $lib_audio_keywords $lib_browser_launcher"
...
bind_dirs=" /media /mnt /run/media /usr/lib/locale /usr/share/fonts /usr/share/themes /var"
...
_remove_more_bloatwares() {
	...
	lib_remove="gcc libgphobos"
	for r in $lib_remove; do
		rm -Rf ./"$APP".AppDir/.junest/usr/lib/"$r"*
	done
	share_remove="gcc gir help i18n"
	...
	#rm -Rf ./"$APP".AppDir/.junest/opt/spotify/libcef*
}
